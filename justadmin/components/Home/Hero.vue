		...
		<div class="relative w-8/12 shrink">
			<div class="flex flex-col justify-start gap-2 pl-28">
				...
				<div class="mt-6 flex items-center justify-start gap-5">
					...
					<div class="btn flex items-center justify-start gap-3 border-2 border-neutral-100/50">
						<a class="font-semibold text-neutral-100" href="#">Download apps</a>
				...
				<div class="relative z-10 ml-auto mt-6">
					<div class="inline-block rounded-lg bg-neutral-100 px-6 py-4 shadow-lg">
						...
						<h5 class="leading-tighter mt-2 text-xl font-semibold tracking-wider">Saving Money</h5>
						<span class="font-medium text-color-primary/80">+38,9%</span>
					</div>
				</div>
				<div class="mt-6 inline-flex items-center justify-start">
					<img alt="Like Tag SVG" src="~/assets/icons/like-tag.svg" />
					<span class="ml-2 text-2xl font-medium leading-tight tracking-wide text-neutral-300">Rated 4.8 / 5.0 from ReviewBest</span>
				</div>
			</div>
		</div>
		<div class="flex-none">
					...
					<div class="mr-6">
						<div class="w-auto p-1.5">
							<div class="flex flex-wrap">
								<img alt="User 1" class="inline-block h-12 w-auto rounded-full" src="~/assets/img/user1.png" />
								<img alt="User 2" class="-ml-5 inline-block h-12 w-auto rounded-full" src="~/assets/img/user2.png" />
								<img alt="User 3" class="-ml-5 inline-block h-12 w-auto rounded-full" src="~/assets/img/user3.png" />
								<img alt="User 4" class="-ml-5 inline-block h-12 w-auto rounded-full" src="~/assets/img/user4.png" />
							</div>
						</div>
					</div>
					<div>
						<h5 class="text-2xl font-semibold">1000+</h5>
						<span class="text-neutral-400">using this apps</span>
					</div>
				</div>
			</div>
		</div>
